...
def reevaluate_metrics(config_path, weights_path):
    # Read JSON file
    ...
    for data_split in ['validation', 'test']:
        ...
        try:
            ...
            reevaluations[data_split] = evaluation
...
if __name__ == '__main__':
    ...
    exp_name = '2023-08-04--08-58-46--02572--antheofficial'  # sameemb_projectoutput
    # exp_name = '2023-08-04--08-57-14--77217--antheofficial'  # no shared
    # exp_name = '2023-08-04--08-54-22--49167--antheofficial' # geglu_gateattention_hsoftpos:2_tcffn:.005_tcpreatt:.07_tclength:2

    config_path = os.path.join(ANTHE_DIR, exp_name, 'results.txt')
    weights_path = os.path.join(ANTHE_DIR, exp_name + '--ckpt-best', 'best_model.h5')

    reevaluate_metrics(config_path, weights_path)
